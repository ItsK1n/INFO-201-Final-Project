...
# Deleted
#test <- read.csv("Data/share-healthy-diet-unaffordable.csv")

death_risk_df <- read.csv("Data/number-of-deaths-by-risk-factor.csv")
food_prices_df <- read.csv("Data/WLD_RTFP_country_2023-11-20 2.csv")
